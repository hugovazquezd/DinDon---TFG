...
class AuthControllerTest {
    ...
    void registerUser() {
        ...
        String testTipoUsuario = "Arrendatario";

        when(userRepository.existsByEmail(testEmail)).thenReturn(false);

        ResponseEntity<?> response = authController.registerUser(new SignUpRequest(testEmail, testPassword, testName, testTipoUsuario));
